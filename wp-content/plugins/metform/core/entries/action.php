...
class Action
{
    ...
    public function submit($form_id, $form_data, $file_data, $page_id = '')
    {
        ...
        $this->response->data['redirect_to'] = (!isset($this->form_settings['redirect_to'])) ? '' : add_query_arg('id', $this->entry_id, $this->form_settings['redirect_to']);
    ...
    private function insert() {
        ...
        //## set stransient and session hashed token for data access checking 
        ...
        $_SESSION['mf_hashed_str_for_access_check'] = $mf_hashed_str_for_access_check;
